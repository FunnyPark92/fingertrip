            ...
            <div class="col-lg-6 h-100 text-center text-lg-right my-auto">
                <ul class="list-inline mb-0">
                    ...
                    <li class="list-inline-item mr-3">
                        <a href="https://www.facebook.com/FingerTrip-319749992128449" target="_blank">
                        	<img src="<c:url value='/img/face.png'/>" alt="핑거트립 페이스북 바로가기">
                        </a>
                    </li>
                    <li class="list-inline-item mr-3">
                        <a href="https://twitter.com/fingertrip2018" target="_blank">
                        	<img src="<c:url value='/img/twit.png'/>" alt="핑거트립 트위터 바로가기">
                        </a>
                    </li>
                    <li class="list-inline-item">
                        <a href="https://www.instagram.com/fingertrip2018" target="_blank">
                        	<img src="<c:url value='/img/insta.png'/>" alt="핑거트립 인스타그램 바로가기">
                        </a>
                    </li>
                </ul>
            </div>
