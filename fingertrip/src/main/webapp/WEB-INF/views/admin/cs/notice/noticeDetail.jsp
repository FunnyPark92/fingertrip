		        ...
		        <c:if test="${listLeng>1 }">
		        	<div class="clear marginTop100 marginBottom90">
		          		<table class="table tableBorder grayBor">
		         			<c:if test="${param.noticeNo==list[1].noticeNo}">
				           		<tr>
				          			<th class="width20"><img class="marR10" alt="이전글" src="${pageContext.request.contextPath }/img/up-arrow.png">이전글</th>
		         			...
		         			<c:if test="${(empty list[2]&&param.noticeNo!=list[1].noticeNo)||!empty list[2]}">
				           		<tr>
				           			<th class="width20"><img class="marR10" alt="다음글" src="${pageContext.request.contextPath }/img/down-arrow.png">다음글</th>
