...
$(document).ready(function(){
	...
	$('#licenseMessage').click(function(){
		$('.lc2').prop("readonly",null);
		$('.lc2').css("background-color","white");
...
<section class="admCenter marginTop40">
	 ...
	 <form name="frm1" method="post" action="<c:url value='/admin/agency/agencyEdit.do'/>" class="agencyWrite">
		<fieldset>
			...
			<div>
				<label for="userid">ID</label> <input type="text" name="id" value="${vo.id}" readonly="readonly" style="background-color: gray">&nbsp;
				<span class="message"></span>
			</div>
			<div>
				<label for="password">비밀번호 변경</label> <input type="password" class="pwd" name="password">
			...
			<div class="div3">
				...
				<input type="text" name="licenseNo1" id="licenseNo1" maxlength="3" title="사업자등록번호 첫번째" class="width_80 valid lc lc2" placeholder="000"> - 
				<input type="text" name="licenseNo2" id="licenseNo2" maxlength="2" title="사업자등록번호 두번째" class="width_80 valid lc lc2" placeholder="00"> -
				<input type="text" name="licenseNo3" id="licenseNo3" maxlength="5" title="사업자등록번호 마지막" class="width_80 valid lc lc2" placeholder="00000">
				<input type="button" id="check" value="사용가능">
				<input type="button" id="licenseMessage" value="중복검사" >
