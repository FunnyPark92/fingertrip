		...
		<form role="form">
			...
			<div class="form-group">
				<label for="userid">회원ID</label> <input type="text"
					class="form-control" id="userid" placeholder="회원ID">
			</div>
			<div class="form-group">
			...
			<div class="form-group" style="margin-bottom: 0px">
				...
				<div class="input-group">
					<input type="text" class="form-control" id="address"
						placeholder="주소 입력"> <span class="input-group-btn">
						<input type="Button" value="우편번호 찾기" class="btn btn-primary"
						class="fa fa-mail-forward spaceLeft" id="btnZipcode" title="새창열림">
					</span>
				</div>
			</div>
			<div class="form-group">
				<div class="input-group" style="width: 525px" style="height:30px">
					<input type="text" class="form-control" style="flex: 0.3"
						id="zipcode" placeholder="우편번호"> <label for="zipcode"></label>
					<input type="text" class="form-control" id="addressDetail"
						placeholder="상세주소"> <label for="addressDetail"></label>
				</div>
			</div>
			<div class="form-group">
				...
				<div class="input-group" style="width: 525px">
					...
					<label for="email1"></label> <select name="email2" id="maile2"
						title="이메일앞자리" class="form-control">
			...
			<div class="form-group">
				...
				<div class="input-group" style="width: 525px">
					<label for="hp"></label> <select name="hp1" id="hp1"
					...
					</select> &nbsp;-&nbsp; <input type="text" class="form-control" id="hp2">
